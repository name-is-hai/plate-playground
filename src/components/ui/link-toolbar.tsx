...
import { KEYS, Editor } from 'platejs';
import {
    useEditorRef,
    useEditorSelection,
    useFormInputProps,
...
export function LinkFloatingToolbar({
    ...
    const isValid = validateUrl(editState.editor, url ?? '');
    const isUnchanged =
        url === attributes.href &&
    ...
    const input = (
        <div className="flex w-[330px] flex-col" {...inputProps}>
            ...
            <div className="flex items-center">
                ...
                <Input
                    disabled={editState.isEditing || insertState.isOpen && textInputProps.defaultValue !== ''}
                    className={inputVariants()}
